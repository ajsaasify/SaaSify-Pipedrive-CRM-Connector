...
//         label: "Product",
//         value:
//           offers?.DealTermDetails?.ProductName ??
//           offers?.DealTermDetails?.ProductID,
//       },
//       {
//         label: "Plan",
//         value:
//           offers?.DealTermDetails?.PlanName ??
//           offers?.DealTermDetails?.ProductID,
//       },
//       {
//         label: "Pricing model",
...
//   ];
//   if (
//     offers?.DealPricingDetails?.PricingJson?.PriceType !== "DiscountedPrice"
//   ) {
//     fields = fields.map((group) =>
//       group.filter((field) => field?.label !== "Discount")
//     );
//   }

//   if (offers?.DealBasicDetails?.StartDateType !== "SpecificMonth") {
//     fields = fields.map((group) =>
//       group.filter((field) => field?.label !== "Start Date")
//     );
//   }
...
// export const processBillingData = (offers: any) => {
...
//   const PlanProviderMonthlyPaymentFrequencyId =
//     offers?.PlanProviderMonthlyPaymentFrequencyId;
//   const PlanProviderAnnualPaymentFrequencyId =
//     offers?.PlanProviderAnnualPaymentFrequencyId;
//   const PlanProvider2YearPaymentFrequencyId =
//     offers?.PlanProvider2YearPaymentFrequencyId;
//   const PlanProvider3YearPaymentFrequencyId =
//     offers?.PlanProvider3YearPaymentFrequencyId;

//   const billingList: any = [];

//   const billingData = [
//     {
//       enabled: IsMonthlyEnabled,
//       title: "1-month",
//       price: PublicPlanProviderMonthlyBillingPrice,
//       frequencyId: PlanProviderMonthlyPaymentFrequencyId,
//       cycle: "Monthly",
//     },
//     {
//       enabled: IsAnnualEnabled,
//       title: "1-year",
//       price: PublicPlanProviderAnnualBillingPrice,
//       frequencyId: PlanProviderAnnualPaymentFrequencyId,
//       cycle: "Annual",
//     },
//     {
//       enabled: IsTwoyearEnabled,
//       title: "2-year",
//       price: PublicPlanProvider2YearBillingPrice,
//       frequencyId: PlanProvider2YearPaymentFrequencyId,
//       cycle: "2Years",
//     },
//     {
//       enabled: IsThreeyearEnabled,
//       title: "3-year",
//       price: PublicPlanProvider3YearBillingPrice,
//       frequencyId: PlanProvider3YearPaymentFrequencyId,
//       cycle: "3Years",
//     },
//   ];
...
//         (d: any) =>
//           d.BillingCycle === cycle && d.PaymentFrequencyId === frequencyId
//       );
